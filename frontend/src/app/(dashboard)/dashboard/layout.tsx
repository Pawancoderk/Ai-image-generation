...
import BreadcrumbPageClient from "~/components/sidebar/breadcrum-page-client";
    ...
    <Providers>
      <SidebarProvider>
        ...
        <SidebarInset className="flex h-screen flex-col">
          <header className="bg-background/95 supports-[backdrop-filter]:bg-background/
          60 border-border/40 sticky top-0 z-10 border-b px-6 py-3 shadow-sm backdrop-blur">
